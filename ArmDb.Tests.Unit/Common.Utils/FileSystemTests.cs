...
public partial class FileSystemTests : IDisposable
{
  ...
  private async Task<byte[]> ReadTestFileBytesAsync(string path)
  {
    // Use BCL File.ReadAllBytesAsync for verification simplicity
